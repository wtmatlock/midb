...
To learn about the archive contents and how to use them, [go here](tutorial.md), and to find a full description of the bioinformatic methods, [go here](workflow.md).
